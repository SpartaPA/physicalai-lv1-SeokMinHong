...
def test_camera_to_base_matches_chain(pipeline, rng):
    ...
    P = rng.uniform(-1, 1, size=(10, 3))  # (N,3) 점군
    assert np.allclose(default_chain().transform("base", "camera", P), transform_points(pipeline.T_base_camera, P))
